...
# CERN openlab Summer Student Project:<br>Quantum Generative Adversarial Networks<br>on <img align="top" height="35px" src="https://render.githubusercontent.com/render/math?math=t\overline{t}H(b\overline{b})"> Process Data Generation
...
<p align="middle">
  ...
  <a>Example of Leading Order (LO) Feynman diagram of the signal process in red and the dominant background process in green[<a href="#references" rel="nofollow">1</a>]. The Higgs Boson is produced in association with <img src="https://render.githubusercontent.com/render/math?math=t\overline{t}"> via gluon fusion and it decays to <img src="https://render.githubusercontent.com/render/math?math=b\overline{b}">. The channel is semi-leptonic as only one of the W bosons decays into leptons.</a>
</p>
...
- Week 3: Trained the cross-entropy loss Dijet-GAN with several different hyperparameters, set up computing instance in GCP.
- Week 4: (in progress).
